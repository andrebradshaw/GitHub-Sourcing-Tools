...
async function gitSearch(obj,p) {
  var res = await fetch(`https://github.com/search?o=${obj.order}&p=${p}&q=location%3A${obj.geo}+language%3A${obj.lang}&type=Users`);
